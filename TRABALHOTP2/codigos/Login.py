...
def logar():
    try:
        with open("TRABALHOTP2\\registros.json", "r+") as ler_json: #Tenta abrir o json
            try:
                ...
                subprocess.run(["python", "TRABALHOTP2\\codigos\\Cadastro.py"]) #Executa o arquivo de cadastro
                return
    ...
    else: #Executa caso o arquivo exista e não esteja vazio
        ...
        if not encontrado:
            ...
            janela_principal.destroy()
            subprocess.run(["python", "TRABALHOTP2\\codigos\\Principal.py"]) #Executa o arquivo principal
        ...
        try:
            ...
            if not encontrado:
                messagebox.showwarning(
                    ...
                    "O cadastro informado não foi encontrado, verifique os dados!")
